...
CDMwebsite/
├── cdm.html               # Homepage
├── aboutcdm.html          # About CDM (mandate, vision, mission)
├── cdmprogram.html        # All programs offered
├── cdmadmission.html      # Admission steps & application
├── cdmcareers.html        # Job openings for faculty
├── cdmcontact.html        # Contact page with working form
├── contact.css            # Contact page styles
├── style.css              # Main homepage styles
├── styleprogram.css       # Programs page styles
├── styleprograms.css      # Alternative programs styles
├── styleadmission.css     # Admission page styles
├── stylecareers.css       # Careers page styles
├── aboutcdm.css           # About page styles
├── script.js              # JavaScript (mobile menu, image slider)
